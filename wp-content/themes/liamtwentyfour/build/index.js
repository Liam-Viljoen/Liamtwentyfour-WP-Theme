...
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_3__.ScrollToPlugin, gsap_TextPlugin__WEBPACK_IMPORTED_MODULE_4__.TextPlugin);
...
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(words[0].childNodes, {
  y: -100,
  ease: "expo.out",
  stagger: 0.05,
  onComplete: () => tl.play()
 ...
 */
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo("footer", {
  yPercent: -80,
  opacity: 0
},
...
textBlocks.forEach(block => {
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(block, {
    opacity: 0,
    // Start invisible
